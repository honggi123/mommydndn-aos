package com.mommydndn.app.ui.care.list.jobposting
...
data class CaregiverJobPostingUiModel(
...
@Composable
fun CaregiverJobPostingList(
    jobPostings: List<CaregiverJobPostingUiModel>,
    ...
    LazyColumn(
        ...
        itemsIndexed(jobPostings) { index, job ->
            with(job) {
            ...
            if (index != jobPostings.lastIndex) {
                Divider(
                    modifier = Modifier
                        .fillMaxWidth()
...
@Composable
internal fun CaregiverJobPostingListItem(
    workPeriod: WorkPeriod,
...
@Preview
@Composable
private fun CaregiverJobPostingListPreview() {
    CaregiverJobPostingListItem(
