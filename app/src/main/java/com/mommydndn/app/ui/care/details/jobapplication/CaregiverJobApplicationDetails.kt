package com.mommydndn.app.ui.care.details.jobapplication
...
import com.mommydndn.app.ui.care.list.jobapplication.CaregiverJobApplicationListItem
...
@Composable
fun CaregiverJobApplicationDetails() {}

@Composable
private fun CaregiverJobApplicationDetailsContent(
    onBackClick: () -> Unit,
    onInquiryClick: () -> Unit,
    onBlockClick: () -> Unit,
    ...
    moreWorkers: List<CaregiverJobApplicationUiModel>,
    isLiked: Boolean,
    onLikeClick: () -> Unit,
    onApplyToClick: () -> Unit,
            ...
            LazyColumn(modifier = Modifier.weight(1F)) {
                ...
                item {
                    CareDetailsAbout(
                        ...
                        tags = preferences.map { it.tagName },
...
private fun CareJobDetailsPreview() {
    CaregiverJobApplicationDetailsContent(
        onBackClick = {},
        onInquiryClick = {},
        onBlockClick = {},
