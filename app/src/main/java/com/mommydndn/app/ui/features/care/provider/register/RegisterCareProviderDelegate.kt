...
interface RegisterCareProviderDelegate {
    ...
    fun setOtherConditions(conditions: List<OtherCondition>)
}

object RegisterCareProviderViewModelDelegate : RegisterCareProviderDelegate {
    ...
    private val _otherConditions = MutableStateFlow(emptyList<OtherCondition>())
    override val otherConditions: StateFlow<List<OtherCondition>> = _otherConditions
    ...
    override fun setOtherConditions(conditions: List<OtherCondition>) {
        _otherConditions.value = conditions
    }
