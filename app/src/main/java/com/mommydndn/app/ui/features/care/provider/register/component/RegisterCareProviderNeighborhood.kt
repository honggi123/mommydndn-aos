...
@Composable
internal fun RegisterCareProviderNeighborhood(
    ...
    Column(
        ...
        PostFieldTitle(
            title = stringResource(R.string.available_neighborhoods),
...
@Preview
@Composable
private fun Neighborhood_Preview() {
    RegisterCareProviderNeighborhood(
        neighborhood = Neighborhood(
            ...
            nearbyNeighborhoods = NearbyNeighborhoods(
                veryDistantNeighborhoods = buildList {
                    repeat(15) {
                        add(
                            Neighborhood(
                                id = 0,
