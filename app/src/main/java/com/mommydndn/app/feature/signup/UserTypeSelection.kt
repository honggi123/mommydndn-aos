package com.mommydndn.app.feature.signup
...
@Composable
internal fun UserTypeSelectionScreen(
    onBackClick: () -> Unit,
    userType: UserType?,
    ...
    Box(modifier = modifier) {
        ...
        Row(
            ...
            UserTypeButton(
                ...
                text = stringResource(id = R.string.company_user),
...
@Preview
@Composable
private fun UserTypeSelectionScreen_Preview() {
