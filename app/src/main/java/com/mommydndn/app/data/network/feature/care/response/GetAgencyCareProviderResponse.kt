...
data class GetAgencyCareProviderResponse(
    ...
    val writer: com.mommydndn.app.data.network.feature.care.response.AgencyCareProviderWriterApiModel,
    @SerialName("coverImageList")
    val coverImages: List<com.mommydndn.app.data.network.feature.care.response.AgencyCareProviderCoverImageApiModel>,
    @SerialName("emd")
...
data class AgencyCareProviderWriterApiModel(
    ...
    val reviews: List<com.mommydndn.app.data.network.feature.care.response.Review>,
    val createdAt: Int,
    val dndnScore: Int,
