...
import com.mommydndn.app.data.network.model.NetworkNearestCareJob
...
import com.mommydndn.app.data.network.service.request.CreateAgencyCareWorkerRequest
...
import com.mommydndn.app.data.network.service.request.PostCareJobRequest
import com.mommydndn.app.data.network.service.request.PostCareWorkerRequest
...
interface CareService {
    ...
    suspend fun getNearestCareJobs(): List<NetworkNearestCareJob>
    ...
    suspend fun createJobOpening(@Body request: PostCareJobRequest): CreateCareJobResponse

    @POST("/api/caring/job-seeker")
    suspend fun createCareWorker(@Body request: PostCareWorkerRequest): CreateCareWorkerResponse
