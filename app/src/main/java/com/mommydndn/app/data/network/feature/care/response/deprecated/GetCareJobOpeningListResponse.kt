package com.mommydndn.app.data.network.feature.care.response.deprecated
...
data class GetCareJobOpeningListResponse(
    ...
    val items: List<com.mommydndn.app.data.network.feature.care.response.deprecated.GetCareJobOpeningListItem>,
    @SerialName("meta")
    val meta: com.mommydndn.app.data.network.feature.care.response.deprecated.Meta,
)
...
data class GetCareJobOpeningListItem(
    ...
    val careTypes: List<@Serializable(with = com.mommydndn.app.data.network.feature.care.response.deprecated.CareTypeSerializer::class) CareType>,
    @SerialName("dateList")
    val oneTimeWorkDates: List<@Serializable(with = com.mommydndn.app.data.network.feature.care.response.deprecated.DateSerializer::class) LocalDate>,
    @SerialName("days")
    val daysOfWeek: List<@Serializable(with = com.mommydndn.app.data.network.feature.care.response.deprecated.DayOfWeekSerializer::class) DayOfWeek>,
    @SerialName("salary")
    val pay: Int,
    @Serializable(with = com.mommydndn.app.data.network.feature.care.response.deprecated.PayPeriodSerializer::class)
    @SerialName("salaryTypeCode")
    val payPeriod: PayPeriod,
    @Serializable(with = com.mommydndn.app.data.network.feature.care.response.deprecated.WorkPeriodSerializer::class)
...
object CareTypeSerializer : KSerializer<CareType> {
    ...
    override fun deserialize(decoder: Decoder): CareType {
        return com.mommydndn.app.data.network.feature.care.response.deprecated.CareTypeSerializer.deserialize(
